...
if __name__ == '__main__':
    ...
    # 数据集所在的目录
    DATA_DIR = '../Medical_Datasets_augmentation/'
    ...
    writer = SummaryWriter("../logs/deeplabv3+/resnet34")
    ...
    # best_model = torch.load('../checkpoint/deeplabv3+/se_resnext50_32x4d/best_model.pth')
    ...
    for i in range(0, 100):
        ...
        if max_score < valid_logs['iou_score']:
            ...
            torch.save(model, '../checkpoint/deeplabv3+/resnet34/best_model.pth')
            print('Model saved!')
